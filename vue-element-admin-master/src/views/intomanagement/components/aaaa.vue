    ...
    handleFile: function(e) {
      ...
      reader.onload = data => {
        ...
        if ($target.className == "hiddenInput") {
          this.msg.license_image = res.result;
          ...
          var n = 0;
          if (this.msg.legal_id_card_img.length >= 2) {
            this.msg.legal_id_card_img.splice(0, 1);
            console.log(++n);
            // console.log(res.result);
          }
          this.msg.legal_id_card_img.push(res.result);
          var param = new FormData(); // 创建form对象
          ...
          this.msg.operator_agreement = res.result;
        } else if ($target.className == "hiddenInput3") {
          this.msg.channel_logo = res.result;
          ...
          this.msg.supplement.push(res.result);
        }
      };
