<template>
    <div class="filter-container" >
        <el-row :gutter="1" class="els">
            ...
            <el-col :xs="6" :sm="5" :md="5" :lg="5" :xl="3">
                <div class="grid-content">商户名称：
                    <el-input
                        placeholder=""
                        v-model="storeName"
                        clearable class="" style="width: 120px;">
                    </el-input></div>
                </el-col>
                 <el-col :xs="6" :sm="5" :md="5" :lg="5" :xl="3">
            ...
            <el-col :xs="6" :sm="6" :md="5" :lg="5" :xl="3">
      ...
      :default-time="['00:00:00', '23:59:59']">
         ...
         <div class="daoBox" >
        <div class="piliang" @click="piliangSubmit">批量连锁商户</div>
        <div class="piliang adds" @click="addChain">新增连锁商户</div>
        </div>
